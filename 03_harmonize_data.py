...
pipeline = [
    ...
    View(
        ...
        select
            postal_code,
            avg(avg_temperature_air_2m_c) avg_temperature_air_f,
        ...
        from GLOBAL_WEATHER__CLIMATE_DATA_FOR_BI.onpoint_id.forecast_day
        where country = 'US'
...
session = Session.builder.config("connection_name", "mpes8").create()
root = Root(session)
